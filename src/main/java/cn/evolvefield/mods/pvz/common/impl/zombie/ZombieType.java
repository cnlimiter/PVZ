...
public abstract class ZombieType extends PAZType implements IZombieType {
	...
	private static final Map<EntityType<? extends PathfinderMob>, IZombieType> BY_ENTITY_TYPE = new HashMap<>();
	/* other data */
    ...
    public static void initZombies() {
    	Static.LOGGER.debug("ZombieManager : registered " + ZOMBIE_SET.size() + " zombies.");
	...
	public static final class ZombieFeatures{
		...
		public ZombieFeatures entityType(Supplier<EntityType<? extends PathfinderMob>> sup) {
			this.entitySup = sup;
			return this;
		}
