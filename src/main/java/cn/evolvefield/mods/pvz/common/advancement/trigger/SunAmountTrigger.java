...
public class SunAmountTrigger extends SimpleCriterionTrigger<SunAmountTrigger.Instance> {

	private static final ResourceLocation ID = StringUtil.prefix("sun_amount");
	public static final SunAmountTrigger INSTANCE = new SunAmountTrigger();
