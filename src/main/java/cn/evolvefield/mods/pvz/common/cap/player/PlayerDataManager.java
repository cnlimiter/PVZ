...
import cn.evolvefield.mods.pvz.common.net.CardInventoryPacket;
import cn.evolvefield.mods.pvz.common.net.PAZStatsPacket;
import cn.evolvefield.mods.pvz.common.net.PVZPacketHandler;
import cn.evolvefield.mods.pvz.common.net.toclient.PlayerStatsPacket;
import cn.evolvefield.mods.pvz.common.world.invasion.Invasion;
...
public class PlayerDataManager {
    ...
    public void setItemAt(ItemStack stack, int pos, boolean sync) {
        pos = Mth.clamp(pos, 0, this.cards.size() - 1);
