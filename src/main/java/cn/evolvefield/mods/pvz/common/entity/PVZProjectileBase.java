 ...
 * Project: pvz
 * Author: cnlimiter
 * Date: 2022/11/14 19:13
 * Description:
 */
public abstract class PVZProjectileBase extends Projectile {
    public PVZProjectileBase(EntityType<? extends Projectile> type, Level world) {
        super(type, world);
    }
