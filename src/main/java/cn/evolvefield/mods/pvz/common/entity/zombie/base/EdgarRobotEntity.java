...
public abstract class EdgarRobotEntity extends AbstractBossZombieEntity {
            ...
            this.getSummonZombie().ifPresent(entity -> {
                if(entity instanceof PVZZombieEntity){
                    ...
                    BlockPos pos = this.getRandom().nextInt(5) == 0 ?
                            LevelUtil.getSuitableHeightRandomPos(this.level, blockPosition(), 20, 40) :
                            LevelUtil.getSuitableHeightRandomPos(this.level, blockPosition(), 3, 8);
    ...
    public void shootElementBall() {
        ...
        ball.setElementBallType(this.getRobotState() == EdgarStates.ICE ? ElementBallEntity.ElementTypes.ICE : ElementBallEntity.ElementTypes.FLAME);
        this.level.addFreshEntity(ball);
        this.setRobotState(EdgarStates.NORMAL);
    ...
    protected Optional<PathfinderMob> getSummonZombie() {
