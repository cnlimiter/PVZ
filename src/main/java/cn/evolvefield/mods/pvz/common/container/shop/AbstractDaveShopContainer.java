...
import cn.evolvefield.mods.pvz.common.advancement.trigger.PVZTradeTrigger;
import cn.evolvefield.mods.pvz.common.container.PVZContainer;
...
public abstract class AbstractDaveShopContainer extends PVZContainer {
    ...
    protected Container output = new SimpleContainer(1);

    public AbstractDaveShopContainer(MenuType<? extends Container> type, int id, Player player, int entityId) {
        super(type, id);
        this.player = player;
